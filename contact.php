...
//taken from http://www.freecontactform.com/email_form.php
 
if(isset($_POST['email'])) {
 
    // EDIT THE 2 LINES BELOW AS REQUIRED
 
    $email_to = "leszek.dubicki@student.ncirl.ie";
 
    $email_subject = "Contact from webpage";
    ...
    $email_from = $_POST['cf_email']; // required
